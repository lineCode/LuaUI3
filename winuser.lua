...
constants.WS_OVERLAPPEDWINDOW = bit.bor(constants.WS_OVERLAPPED,
									  constants.WS_CAPTION,
									  constants.WS_SYSMENU,
									  constants.WS_THICKFRAME,
									  constants.WS_MINIMIZEBOX,
									  constants.WS_MAXIMIZEBOX)
constants.WS_TILEDWINDOW   = constants.WS_OVERLAPPEDWINDOW
constants.WS_CHILDWINDOW   = constants.WS_CHILD

constants.WS_TILED         = constants.WS_OVERLAPPED
constants.WS_ICONIC        = constants.WS_MINIMIZE
constants.WS_SIZEBOX       = constants.WS_THICKFRAME
...
constants.WS_POPUPWINDOW         = bit.bor(constants.WS_POPUP, constants.WS_BORDER, constants.WS_SYSMENU)
constants.WS_EX_OVERLAPPEDWINDOW = bit.bor(constants.WS_EX_WINDOWEDGE, constants.WS_EX_CLIENTEDGE)
constants.WS_EX_PALETTEWINDOW    = bit.bor(constants.WS_EX_WINDOWEDGE, constants.WS_EX_TOOLWINDOW, constants.WS_EX_TOPMOST)

constants.CW_USEDEFAULT = 0x80000000 --if used for x, then y must be a SW_* flag
...
constants.IDC_ARROW = MAKEINTRESOURCE(32512);

WINUSER = readonly_table(constants);